...
void ParticleSystem::Draw()
{
    ...
    glBufferData(GL_ARRAY_BUFFER, MAX_PARTICLES * sizeof(Particle), m_particles, GL_DYNAMIC_DRAW);
    ...
    // Draw points with Vertex Shader, then pass points to Geometry Shader
